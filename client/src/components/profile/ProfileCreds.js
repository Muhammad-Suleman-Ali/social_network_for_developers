    ...
    render() {
        ...
        const expItem = experience.map(exp => (
            <li key='exp._id' className='list-group-item'>
                ...
                <p> {exp.description === '' ? (<span><strong>Description:</strong>There is No Description given</span>) : (
        ...
        const eduItem = education.map(edu => (
            <li key='edu._id' className='list-group-item'>
                ...
                <p> {edu.description === '' ? (<span><strong>Description:</strong>There is No Description given</span>) : (
                    <span> <strong>Description:</strong> {edu.description}</span>)}</p>
